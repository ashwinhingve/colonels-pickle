...
export function HeroSlider({ slides: propSlides }: HeroSliderProps) {
  ...
  return (
    <section
      className="relative w-full overflow-hidden bg-gray-900 [transform:translate3d(0,0,0)] h-[56.25vw] min-h-[420px] md:min-h-0 md:h-[600px] lg:h-[700px]"
    ...
    >
      <AnimatePresence initial={false} custom={direction}>
        ...
        >
          ...
          {/* Content */}
          <div className="relative h-full container mx-auto px-4 flex items-center pb-16 md:pb-0">
            <div className="max-w-2xl">
              ...
              >
                <span className="inline-block bg-gradient-to-r from-amber-500 to-red-600 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-full text-xs md:text-base font-semibold shadow-lg">
                  {slide.subtitle}
                </span>
              </motion.div>
              ...
              <motion.h2
                ...
                className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-2 md:mb-6 leading-tight"
              >
                {slide.title}
              </motion.h2>
              ...
              <motion.p
                ...
                className="text-sm sm:text-base md:text-xl lg:text-2xl text-gray-200 mb-4 md:mb-8 leading-relaxed line-clamp-2 md:line-clamp-none"
              >
                {slide.description}
              </motion.p>
              ...
              >
                {slide.ctaText && (
                  <Link href={slide.ctaLink || "/products"}>
                    <Button
                      size="lg"
                      className="text-sm md:text-lg px-5 md:px-8 py-4 md:py-6 bg-gradient-to-r from-amber-600 to-red-700 hover:from-amber-700 hover:to-red-800 text-white shadow-2xl hover:shadow-amber-500/50 transition-all duration-300 transform hover:scale-105"
                    >
                      {slide.ctaText}
                    </Button>
                  </Link>
                ...
                {slide.ctaSecondaryText && (
                  <Link href={slide.ctaSecondaryLink || "/products"}>
                    <Button
                      size="lg"
                      variant="outline"
                      className="text-sm md:text-lg px-5 md:px-8 py-4 md:py-6 border-2 border-white text-white hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-105"
                    >
                      {slide.ctaSecondaryText}
                    </Button>
                  </Link>
