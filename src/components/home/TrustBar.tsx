...
// Rotates through the stamp accent palette (gunmetal / sand / terracotta).
const STAMP_COLORS = ["#3D4550", "#A89A6E", "#9C4420"];
                ...
                <div className="flex flex-col items-center gap-2 text-center">
                  <div className="relative flex h-11 w-11 items-center justify-center">
                    <InkStampRound
                      ...
                      aria-hidden
                    />
                    <item.Icon className="relative h-6 w-6 text-cp-olive" aria-hidden />
                  </div>
