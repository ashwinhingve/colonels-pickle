          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-4 flex gap-3">
              <a
                ...
                className="text-white transition-all duration-200 hover:text-cp-saffron hover:scale-110"
              >
            ...
            <ul className="space-y-2 text-sm">
              {PRODUCT_LINKS.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="transition-all duration-200 hover:text-cp-saffron-muted hover:translate-x-1"
                  >
                    {link.label}
                  </Link>
                </li>
