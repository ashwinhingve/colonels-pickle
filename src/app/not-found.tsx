...
export default function NotFound() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center bg-cp-cream px-4 text-center">
      <SpilledJarIllustration className="animate-float mb-2 w-56 max-w-[70vw]" />
      <h1 className="font-display text-7xl font-extrabold text-cp-crimson">404</h1>
      <h2 className="mt-2 font-display text-2xl font-bold text-cp-text">
        Page not found
      </h2>
      <p className="mt-3 max-w-md font-serif text-cp-text-muted">
        Looks like this jar tipped over. The page you&apos;re after doesn&apos;t
        exist or has moved.
      </p>
