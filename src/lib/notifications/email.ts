      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>© ${new Date().getFullYear()} Colonel's Pickle. All rights reserved.</p>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="margin-top: 20px;">Thank you for shopping with Colonel's Pickle!</p>
            </div>
            <div class="footer">
              <p>© ${new Date().getFullYear()} Colonel's Pickle. All rights reserved.</p>
            </div>
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Colonel's Pickle Admin Notification</p>
            </div>
          </div>
        </body>
      </html>
    ...
    const html = `
      <!DOCTYPE html><html><head><style>
        ...
        <div class="container">
          ...
          <div class="footer"><p>Colonel's Pickle Admin Notification</p></div>
        </div>
      </body></html>`;
    await this.sendEmail(adminEmail, subject, html);
  }
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Hello,</p>
              <p>Use the following code to sign in to your Colonel's Pickle account:</p>
            ...
            <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Colonel's Pickle. All rights reserved.</p>
            </div>
          </div>
        </body>
      </html>
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Dear Customer,</p>
              <p>Your order <strong>${order.orderNumber}</strong> has been delivered. We hope you're enjoying your Colonel's Pickle products!</p>
              ...
              <p>Thank you for choosing Colonel's Pickle. We look forward to serving you again!</p>
            </div>
            <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Colonel's Pickle. All rights reserved.</p>
            </div>
    ...
    const html = `
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1 style="color:#fff;margin:0;font-size:28px;">Welcome to COLONEL'S PICKLE!</h1>
              <p style="color:rgba(255,255,255,0.85);margin:8px 0 0;font-size:15px;">The Taste of Purity</p>
            </div>
            <div class="content">
              <p>${greeting}</p>
              <p>Thank you for joining Colonel's Pickle by Ridhwika Agro Organics — your destination for 100% adulteration-free spices, oils, and superfoods sourced straight from trusted farms.</p>
              ${promoBlock}
            ...
            <div class="footer">
              <p>© ${new Date().getFullYear()} Colonel's Pickle by Ridhwika Agro Organics. All rights reserved.</p>
            </div>
          </div>
        </body>
      </html>`;
